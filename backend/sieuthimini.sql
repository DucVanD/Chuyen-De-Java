...
-- Dumping data for table chuyendejava.contacts: ~2 rows (approximately)
...
-- Dumping data for table chuyendejava.orders: ~4 rows (approximately)
...
-- Dumping data for table chuyendejava.order_details: ~9 rows (approximately)
...
-- Dumping data for table chuyendejava.password_reset_tokens: ~1 rows (approximately)
...
-- Dumping data for table chuyendejava.stock_movements: ~8 rows (approximately)
...
-- Dumping data for table chuyendejava.users: ~2 rows (approximately)
