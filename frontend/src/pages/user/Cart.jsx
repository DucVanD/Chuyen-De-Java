...
const Cart = () => {
  ...
  const handleCheckout = () => {
    if (!isLoggedIn) {
      ...
      // ✅ Ghi nhớ trang checkout để quay lại sau khi login
    ...
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between bg-white rounded-2xl shadow-sm px-5 py-4 border border-gray-100">
        <div>
          ...
          <p className="text-gray-500 mt-1 text-sm sm:text-base">
            Bạn hiện có{" "}
            <span className="font-semibold text-green-600">{cartItems.length}</span>{" "}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                  ...
                  >
                    <div className="col-span-5 flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 text-sm">{item.category?.name || "Sản phẩm"}</p>
                      </div>
                    </div>
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          {/* Mã giảm giá */}
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">🎁 Mã giảm giá khả dụng</h3>
